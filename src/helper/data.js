export const data = [
  ...
  },
  {
    ...
    desc: "The Cliffs of Moher are entirely vertical and the cliff edge is abrupt. On a clear day, the views are tremendous, with the Aran Islands etched on the waters of Ireland Galway Bay. From the cliff edge, you can just hear the booming far below as the waves crash and gnaw at the soft shale and sandstone.  With a due-west exposure, sunset is the best time to visit.",
    image: "https://images.alphacoders.com/885/885418.jpg",
  },
  {
    id: 3,
    title: "Bali",
